...
export default function Steps() {
  return (
    <section>
      <div className="py-20 mx-8 grid grid-flow-col grid-cols-2 gap-6">
        <div>
          <div className="max-w-sm xl:max-w-md mr-auto">
        ...
        <ul className="space-y-8 divide-greyShade2 divide-y-[1px]">
          <li className="flex items-center space-x-8 flex-1 w-full">
            <div className="rounded-full h-12 w-12 grid place-content-center bg-grey border-[1px] border-greyShade2">
          ...
          <li className="flex items-center space-x-8 flex-1 w-full pt-6">
            <div className="rounded-full h-12 w-12 grid place-content-center bg-grey border-[1px] border-greyShade2">
