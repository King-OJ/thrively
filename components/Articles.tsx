...
export default function Articles() {
  return (
    <section>
      <div className="mx-8 md:mx-10 my-5 md:my-6">
            ...
            <div className="relative top-0 right-0 h-full w-full bg-white left-0 bottom-0 p-3 z-20 rounded-2xl border">
              <div className="flex flex-col items-center space-y-3">
                <Image
                  ...
                  height={0}
                  sizes="100vw"
                  className="w-full md:w-auto h-auto border border-black rounded-lg overflow-hidden"
                />
                <div className="mx-2">
                  <div className="flex items-center justify-between">
                    <h5 className="text-sm capitalize">Time & productivity</h5>
                    <div className="border border-greyShade2 p-[3px] px-[6px] space-x-2 rounded-full flex items-center">
                      <Image
                        ...
                        height={0}
                        sizes="100vw"
                        className="opacity-80 w-auto h-auto scale-150 md:scale-125"
                      />
                  ...
                  <button className="w-full font-subheadingBoldFont justify-center mt-6 flex items-center text-xs bg-redish py-2 text-white rounded-full">
                    <span>Read Now</span>
                    <span className="ml-1">
                      <Image
              ...
              <div className="flex flex-col items-center space-y-3">
                ...
                <div className="mx-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="border border-greyShade2 py-[3px] px-[6px] space-x-2 rounded-full flex items-center">
                      <Image
                        src="/assets/mdi_clock-outline.png"
                        alt="arrow"
                        width={0}
                  ...
                  <button className="w-full font-subheadingBoldFont justify-center mt-6 flex items-center text-xs border border-redish py-2 text-redish rounded-full">
                    <span>Read Now</span>
                    <span className="ml-1">
                      <Image
